translate chinese mar_door_knock_bca3ac64:
    # "*Knock* *Knock*"
    "*咚咚*"
...
translate chinese mar_door_knock_54c757bc:
    # anon f_worried @ -m_talk "( I hope someone's home. )"
    anon f_worried @ -m_talk "(希望有人在家。)"

translate chinese mar_door_knock_bca3ac64_2:
    # "*Knock* *Knock*"
    "*咚咚*"
...
translate chinese mar_door_knock_7f5e5f2f:
    ...
    maria a_top_off_01 e_e f_horny o_right "跟我来。"

translate chinese mar_door_knock_f79c204b:
    # anon "Huh?"
    anon "嗯？"
...
translate chinese mar_door_knock_88218f5e:
    # anon "The bedroom again?"
    anon "又是卧室？"
...
translate chinese mar_door_maria_merge1_416a6300:
    # maria "That's it!!"
    maria "就是这样！！"
...
translate chinese mar_door_maria_merge1_9ebbc879:
    # maria "You pulled out?"
    maria "你拔出来了？"

translate chinese mar_door_maria_merge1_d8f50d3e_1:
    # anon "Yeah."
    anon "嗯。"

translate chinese mar_door_maria_merge1_9ac806c2:
    # anon "Sorry."
    anon "抱歉。"
...
translate chinese mar_door_maria_creampie_d165fd93:
    # anon "Haah... haah..."
    anon "哈啊……哈啊……"
