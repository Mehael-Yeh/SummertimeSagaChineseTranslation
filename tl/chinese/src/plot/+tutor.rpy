...
# game/src/plot/+tutor.rpy:15
translate chinese tutor_hud_7e20175f:

    # tutor "Welcome to [config.name]!" with dissolvefast
    tutor "欢迎使用[config.name]！" with dissolvefast

# game/src/plot/+tutor.rpy:21
translate chinese tutor_hud_092830f3:

    # nvl clear
    # tutor "This is the pause button. It leads to the save and load menus, settings, and allows you to return to the main menu."
    nvl clear
    tutor "这是暂停按钮。它可以进入存储和载入菜单、设置，并允许你返回主菜单。"

# game/src/plot/+tutor.rpy:29
translate chinese tutor_hud_40bb7719:

    # tutor "It can also be accessed with tap-and-hold."
    tutor "也可以通过长按来访问。"

# game/src/plot/+tutor.rpy:31
translate chinese tutor_hud_5b6419c4:

    # tutor "It can also be accessed with right-click."
    tutor "也可以通过右键点击来访问。"

# game/src/plot/+tutor.rpy:37
translate chinese tutor_hud_3e3676fe:

    # nvl clear
    # tutor "These two boxes tell you what day of the week it is..."
    nvl clear
    tutor "这两个框分别告诉你今天是星期几……"

# game/src/plot/+tutor.rpy:45
translate chinese tutor_hud_5ec815fb:

    # extend " and where you are, respectively."
    extend "以及你在哪里。"

# game/src/plot/+tutor.rpy:46
translate chinese tutor_hud_ffa09f64:
    ...
    tutor "就像在生活中一样，有些活动只在特定日期可用。一个很好的例子是课程，只在周一至周五进行。"

# game/src/plot/+tutor.rpy:47
translate chinese tutor_hud_300a2a92:
...
translate chinese tutor_hud_dead2801:
    ...
    nvl clear
    tutor "点击背包图标可进入物品栏。其中包含在镇上收集的所有物品，以及它们的名称和描述。"

# game/src/plot/+tutor.rpy:81
translate chinese tutor_hud_5cdba178:
    ...
    tutor "有些物品可以进一步检查，或在极少数情况下直接从物品栏中使用。如果你发现自己被困在涉及特殊物品的任务中，这一点值得牢记。"

# game/src/plot/+tutor.rpy:94
translate chinese tutor_hud_a1690f6a:

    # nvl clear
    # tutor "The phone contains a multitude of in-game functionality, including text messages, statistics, and quest hints."
    nvl clear
    tutor "手机包含多种游戏内功能，包括短信、统计数据和任务提示。"

# game/src/plot/+tutor.rpy:105
translate chinese tutor_hud_64dceacd:

    # nvl clear
    # tutor "This display shows the cash currently on hand."
    nvl clear
    tutor "此显示区域显示当前持有的现金。"
...
# game/src/plot/+tutor.rpy:127
translate chinese tutor_hud_d8b8d774:

    # extend " morning"
    extend "早晨"

# game/src/plot/+tutor.rpy:132
translate chinese tutor_hud_87e6a60e:

    # extend ", afternoon"
    extend "、下午"

# game/src/plot/+tutor.rpy:137
translate chinese tutor_hud_83fee351:

    # extend ", evening"
    extend "、傍晚"

# game/src/plot/+tutor.rpy:142
translate chinese tutor_hud_adc7b976:

    # extend ", and night."
    extend "和夜晚。"

# game/src/plot/+tutor.rpy:147
translate chinese tutor_hud_b9189a88:

    # tutor "Clicking on a time of day in the future will advance time until then.{w} Unless you're interrupted of course."
    tutor "点击未来的某个时段会将时间推进到那之前。{w} 当然，除非你被打断。"

# game/src/plot/+tutor.rpy:155
translate chinese tutor_hud_f7824ffa:

    # tutor "You can't use it just yet though, plenty of things to do this morning!"
    tutor "不过你现在还无法使用它，今天早晨还有很多事情要做！"

# game/src/plot/+tutor.rpy:156
translate chinese tutor_hud_ed7c1177:

    # tutor "Have fun!"
    tutor "玩得开心！"

# game/src/plot/+tutor.rpy:165
translate chinese tutor_hud_d41d8cd9:
